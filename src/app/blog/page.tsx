...
export const metadata: Metadata = {
  title: "Blog | Disnet",
  description: "Artículos sobre logística, operadores 3PL y e-commerce.",
};
  ...
  return (
    <section>
      <div className="mx-auto max-w-3xl px-6 py-20">
        <Reveal>
          <h1 className="text-h1">Blog sobre logística</h1>
          <p className="mt-4 text-muted-foreground">
            Novedades, análisis y consejos del equipo de Disnet sobre operaciones logísticas y cadena de
            suministro.
          </p>
        </Reveal>
        ...
        <div className="mt-14 space-y-8">
          {blogPosts.map((post, i) => (
            <Reveal key={post.slug} delay={Math.min(i, 4) * 0.06}>
              <Link href={`/blog/${post.slug}`} className="group block border-b border-border pb-8 last:border-b-0">
